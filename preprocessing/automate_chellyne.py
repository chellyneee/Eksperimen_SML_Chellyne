...
def run_preprocessing():
    ...
    try:
        df_user = pd.read_csv('../TourismDestination_raw/user.csv')
        df_rating = pd.read_csv('../TourismDestination_raw/tourism_rating.csv')
        df_tourism = pd.read_csv('../TourismDestination_raw/tourism_with_id.csv')
